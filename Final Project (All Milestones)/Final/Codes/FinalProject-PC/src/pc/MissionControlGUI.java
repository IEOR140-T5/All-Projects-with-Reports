...
public class MissionControlGUI extends JFrame implements CommListener {
	...
	private JLabel lblDataY, lbl2Y, lblAngle, lblHeading, timerLabel;
	private JLabel lblDataX, lblPose, lblEcho, lblStatus, lblStatusArea;
	...
	public MissionControlGUI() {
		...
		statusTextArea = new JTextArea(15, 21);
	...
	/**
	 * Private class to display a timer for the final demonstration.
	 * @author Short
	 *
	 */
