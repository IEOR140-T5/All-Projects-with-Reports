...
/**
 * Record light sensor data for line follower experiments. Displays left, right
 * sensor values. Press ENTER to record, ESCAPE to end data collection and
 * transmit. Left sensor = S1, right sensor = S4; Run DownloadDL to receive the
 * data and display it on your PC>.
 * 
